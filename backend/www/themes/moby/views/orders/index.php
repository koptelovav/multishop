...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        array(
            ...
            'type' => 'raw',
            'value' => function ($data) {
                    echo  CHtml::link($data->id, '#',array('class'=>'open-menu')).'<br/>';
                    ...
                    $complete = CHtml::link('Обработан', '#', array('data-id'=>$data->id,'class'=>'complete'));
                    $box = CHtml::link('На сборку', 'tel://'.$data->customer->phone);
                    echo <<<EOF
...
EOF;
        ...
        array(
            'name' => 'date',
            'value' => function ($data) {
                    echo $data->customer->name.'<br/><br/>'.SHtml::toHumanDate($data->date);
                    if($data->comment){
