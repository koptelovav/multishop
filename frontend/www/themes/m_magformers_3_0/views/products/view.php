...
<div class="container">
    <div id="product" class="product-view" itemscope itemtype="http://schema.org/Product">
        <div class="product-view--inside row">
            <div class="col-xs-12">
                <div class="images <?= count($model->images) ? 'images--slick-carousel' : ''?>">
                    <div>
                    ...
                    <?php foreach ($model->images as $image): ?>
                        <div>
                            <img class="img-responsive" alt="<?= $image->alt ?>"
                                 src="<?= Yii::app()->imageApi->createUrl(PHtml::IMAGE_VIEW, Yii::app()->media->webroot . $image->url) ?>"/>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
            <div class="col-xs-12">
                <div class="summary">
                    ...
                    <div class="product-view--title-wrap">
                        <div class="product-view--title" itemprop="name"><?php echo $model->title ?></div>

                        <span class="product-view--offer" itemprop="offers" itemscope
                    ...
                    <?php echo Cart::buyButton($model, '<span class="btn--inside">В корзину</span>', 'btn btn--wide', "yaCounter41166644.reachGoal('ADD_TO_CART'); return true;") ?>


                    <section class="info">
                        <div class="product-advantages row">
                            <a href="#" class="product-advantages--item col-xs-6" data-toggle="modal" data-target="#freeDelivery">
