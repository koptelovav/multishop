...
$(function(){
    $('._view-composition').on('mouseenter',function(){
        var $self = $(this);
        $('#product-image_'+$self.data('product-id')).find('img').attr('src', $self.data('image'));
    }).on('mouseleave', function(){
        var $self = $(this);
        var $productImage = $('#product-image_'+$self.data('product-id'));
        $productImage.find('img').attr('src', $productImage.data('image'));
    });

    $('[data-show-equipment]').click(function(){
        var $button = $(this),
            $offer = $($button.data('show-equipment')),
            $offers = $('.product-offers .offer');

        $offers.removeClass('active').find('.product-equipment').slideUp();
        $offer.slideDown();
        $button.parent().parent().parent().toggleClass('active');
        return false;
    });
