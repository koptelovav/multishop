...
$this->firstTitle = 'Оригинальный конструктор Magformers';
$this->secondTitle = 'Безопасный! Развивающий! Иновационный! Безграничный...';
$this->thirdTitle = 'Вы можете купить Магформерс в нашем интренет-магазине с быстрой и бесплатной доставкой по всей России.
                <br>Сделайте это сейчас и начните создавать свой неповторимый мир вместе с магформерс уже сегодня!';
...
<section class="main-page-item section--advantage">
    ...
    <div class="advantages-list row">
        <div class="advantage col-xs-12 col-md-3">
