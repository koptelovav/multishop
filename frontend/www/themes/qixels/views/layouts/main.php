            ...
            <div class="header-wrap">
                <div class="header-info hidden-xs">
                    <a class="logo" href="<?= Yii::app()->homeUrl ?>">
                        <img class="img-responsive" src="<?= Yii::app()->theme->baseUrl ?>/img/logo/logo_sm.jpg" alt="">
                    </a>
                    ...
                    <nav id="navigation" class="navbar navbar-default" role="navigation">
                            <div class="row navbar-header">
                                ...
                                <div class="col-xs-6 header-logo visible-xs">
                                    <a class="logo" href="<?= Yii::app()->homeUrl ?>">
                                        <img class="img-responsive" src="<?= Yii::app()->theme->baseUrl ?>/img/logo/logo_xs.jpg" alt="">
                                    </a>
                                </div>
        ...
        <div class="footer-container">
            <footer id="footer" class="clearfix">
                <div class="bottom-footer">
                    &copy; <?= date('Y')?>гг. - <a href="http://myhatchimals.ru">Qixels3D.ru</a>
